...
{
	FVector Direction = TargetLocation - FVector(-800.0f, 400.0f, 160.0f);  // restar dos vectores da como resultado un vector que va desde el segundo vector al primero
	float DistanceToTarget = FVector::Dist(TargetLocation, FVector(-800.0f, 400.0f, 160.0f));  // calcular la distancia entre dos vectores
